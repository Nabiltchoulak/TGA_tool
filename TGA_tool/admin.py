...
from TGA_tool.models import Parent,Eleve,Requete,Payement,Cours,ElevePotentiel,Famille,Seance_Cours,Seance_Coaching,Coach,Salle,Chapitre,Notions,Matiere,Frequence,Creneau,Curriculum
